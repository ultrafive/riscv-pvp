...
from isa.rvc.rvc import *

class BaseCase_rvc(BaseCase):
...
class Test_rvc(BaseTest):
    inst = Rvc
    @pytest.mark.parametrize( 'precondition, test', [
        [ background + 'li sp, 0x1234', '''
  ...
  RVC_TEST_CASE (42, t0, 0x246, li a0, 0x123; c.mv t0, a0; c.add t0, a0)
    ...
    def test_rvc( self, precondition, test ):
        simulate( self, Case_rvc, precondition=precondition, test=test )
