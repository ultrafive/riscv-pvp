...
_: &default
  ...
  cases:
    test_vxxx_vi_without_mask:
      ...
      - '[np.linspace(0, 1, 16, dtype=np.int32), 9, 16]'
      - '[np.linspace(0, -1, -31, dtype=np.int32), 13, 31]'
      - '[np.linspace(0, -15, 16, dtype=np.int32), 15, 32]'

    test_vxxx_vi_with_mask:
      - '[np.array([4], dtype=np.int32), 4, np.array([0x5a], dtype=np.uint8), 1]'
      - '[np.linspace(0, 1, 16, dtype=np.int32), 3, np.array([0x5a, 0xa5], dtype=np.uint8), 16]'
      - '[np.linspace(0, -1, -31, dtype=np.int32), 9, np.linspace(0, 255, 4, dtype=np.uint8), 31]'
      - '[np.linspace(0, -15, 16, dtype=np.int32), 15, np.linspace(0, 255, 4, dtype=np.uint8), 32]'
